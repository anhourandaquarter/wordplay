enum Sym {
    EvalOpen = '(',
    EvalClose = ')',
    NumberExcludeOpen = 'NumberRange(', 
    NumberExcludeClose = 'NumberRange)',
    SetOpen = '{',
    SetClose = '}',
    ListOpen = '[',
    ListClose = ']',
    NumberIncludeOpen = 'NumberRange[',
    NumberIncludeClose = 'NumberRange]',
    TagOpen = '<',
    TagClose = '>',
    Bind = ':',
    Access = '.',
    ...
    TypeClose = '⸩',
    Separator = ',',
    NumberSeparator = 'NumberRangeSeparator,',
    Language = '/',
    Region = '-',
    BooleanType = '•?',
    NumberType = '•#',
